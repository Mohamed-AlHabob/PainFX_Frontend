...
const Menu = ({ orientation }: MenuProps) => {
  ...
  switch (orientation) {
    case "desktop":
      return (
        <Card className="dark:bg-themeGray dark:border-themeGray bg-clip-padding backdrop--blur__safari backdrop-filter backdrop-blur-2xl bg-opacity-60 p-1 lg:flex  md:rounded-xl flex items-center justify-center w-fit">
